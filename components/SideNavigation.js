...
const {id, sideNavStatus} = props;

const navigation = [
  { name: "Profile", href: "/profile", icon: HomeIcon, current: false },
  { name: "My Inventory", href: "/vehicles", icon: ViewListIcon, current: false },
...
navigation[props.id].current = props.sideNavStatus;

console.log("Boolean status", navigation[1].current )
...
const addHandler = () => {
  ...
  return (
    <>
      <div className="min-h-full flex-column lg:mx-10 lg: w-1/6">
